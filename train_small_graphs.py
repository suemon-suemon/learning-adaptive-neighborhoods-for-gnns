...
parser.add_argument(
    "--root",
    type=str,
    default="/home/jiayin/PycharmProjects/learning-adaptive-neighborhoods-for-gnns/model",
    help="root directory",
)
parser.add_argument(
    "--expname",
...
parser.add_argument("--model", type=str, default="GAT", help="model name")
parser.add_argument(
    "--edge_noise_level",
    type=float,
    default=0.00014,
...
def load_data(args):
    ...
    root = "/home/jiayin/PycharmProjects/learning-adaptive-neighborhoods-for-gnns/data/graph_data/{}".format(args.data)
